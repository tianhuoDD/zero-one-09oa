...
public://定义接口
	...
	// 3.2 定义新增接口处理
	ENDPOINT(API_M_POST, "/base/template-built", addformTemplateBuilt, BODY_DTO(formTemplateBuiltDTO::Wrapper, dto), API_HANDLER_AUTH_PARAME) {
		// 呼叫执行函数响应结果
	...
	// 3.2 定义删除接口处理
	API_HANDLER_ENDPOINT_AUTH(API_M_DEL, "/base/template-delete/{xid}", removeformTemplateBuilt, PATH(UInt64, xid), executeremoveformTemplateBuilt(xid));
