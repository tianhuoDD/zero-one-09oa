...
public:
    ...
    ENDPOINT(API_M_GET, "/base/query-all", getAllTemplates, QUERIES(QueryParams, queryParams), API_HANDLER_AUTH_PARAME) {
...
private:
    FormTemplatePageJsonVO::Wrapper execQuerySample(const FormTemplateQuery::Wrapper& query, const PayloadDTO& payload);
};
