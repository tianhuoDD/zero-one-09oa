...
*/
#ifndef _MEETINGROOMVO_H_
#define _MEETINGROOMVO_H_
 ...
 * 会议室信息显示对象
 */
class MeetingroomVO : public oatpp::DTO
{
	DTO_INIT(MeetingroomVO, DTO);
	//会议室id
...
/**
 * 个人信息显示JsonVO，用于响应给客户端的Json对象
 */
class MeetingroomJsonVO : public JsonVO<MeetingroomVO::Wrapper> {
	DTO_INIT(MeetingroomJsonVO, JsonVO<MeetingroomVO::Wrapper>);
};

#include OATPP_CODEGEN_END(DTO)

#endif // !_MEETINGROOMVO_H_