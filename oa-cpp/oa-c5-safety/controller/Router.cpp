...
#include "UserPassword/UserPasswordController.h"
#include "userloginconfiguration/UserLoginConfigurationController.h"
...
void Router::initRouter()
{
	...
	ROUTER_SIMPLE_BIND(UserLoginConfigurationController);
}
