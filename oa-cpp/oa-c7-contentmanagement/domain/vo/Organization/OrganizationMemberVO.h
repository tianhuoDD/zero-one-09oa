...
*/
#ifndef _ORGANIZATION_MEMBERVO_H_
#define _ORGANIZATION_MEMBERVO_H_
 ...
 */
class OrganizationMemberPageJsonVO: public JsonVO<OrganizationMemberPageDTO::Wrapper> {
	DTO_INIT(OrganizationMemberPageJsonVO, JsonVO<OrganizationMemberPageDTO::Wrapper>);
};
