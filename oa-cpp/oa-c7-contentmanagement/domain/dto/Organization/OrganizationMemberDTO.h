 ...
 */
class OrganizationMemberPageDTO : public PageDTO<OrganizationMemberDTO::Wrapper> 
{
	DTO_INIT(OrganizationMemberPageDTO, PageDTO<OrganizationMemberDTO::Wrapper>);
};
