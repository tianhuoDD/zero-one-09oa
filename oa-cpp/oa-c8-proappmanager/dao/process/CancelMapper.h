#pragma once
#ifndef _CANCEL_MAPPER_
#define _CANCEL_MAPPER_
#include "Mapper.h"
#include "domain/do/process/CancelDO.h"


class CancelMapper : public Mapper<CancelDO> {
public:
	CancelDO mapper(ResultSet* resultSet) const override {
		CancelDO data;
