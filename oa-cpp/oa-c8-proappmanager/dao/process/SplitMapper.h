#pragma once
#ifndef _SPLIT_MAPPER_
#define _SPLIT_MAPPER_
#include "Mapper.h"
#include "domain/do/process/SplitDO.h"


class SplitMapper : public Mapper<SplitDO> {
public:
	SplitDO mapper(ResultSet* resultSet) const override {
		SplitDO data;
