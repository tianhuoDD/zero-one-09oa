#pragma once
#ifndef _BEGIN_MAPPER_
#define _BEGIN_MAPPER_
#include "Mapper.h"
#include "domain/do/process/BeginDO.h"


class BeginMapper : public Mapper<BeginDO> {
public:
	BeginDO mapper(ResultSet* resultSet) const override {
		BeginDO data;
