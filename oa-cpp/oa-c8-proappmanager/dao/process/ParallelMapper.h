#pragma once
#ifndef _PARALLEL_MAPPER_
#define _PARALLEL_MAPPER_
#include "Mapper.h"
#include "domain/do/process/ParallelDO.h"


class ParallelMapper : public Mapper<ParallelDO> {
public:
	ParallelDO mapper(ResultSet* resultSet) const override {
		ParallelDO data;
