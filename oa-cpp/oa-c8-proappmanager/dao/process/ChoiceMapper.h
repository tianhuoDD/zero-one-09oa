#pragma once
#ifndef _CHOICE_MAPPER_
#define _CHOICE_MAPPER_
#include "Mapper.h"
#include "domain/do/process/ChoiceDO.h"


class ChoiceMapper : public Mapper<ChoiceDO> {
public:
	ChoiceDO mapper(ResultSet* resultSet) const override {
		ChoiceDO data;
