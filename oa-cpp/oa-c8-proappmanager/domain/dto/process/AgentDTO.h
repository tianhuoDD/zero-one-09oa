...
class AgentDTO : public oatpp::DTO {
	DTO_INIT(AgentDTO, DTO);
	...
	API_DTO_FIELD_DEFAULT(String, xagentInterruptScript, "xagentInterruptScript");
	API_DTO_FIELD_DEFAULT(String, xagentInterruptScriptText, "xagentInterruptScriptText");
