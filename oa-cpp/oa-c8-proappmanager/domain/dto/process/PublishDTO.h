#pragma once
#ifndef _PUBLISH_DTO_
#define _PUBLISH_DTO_
...
class PublishDTO : public oatpp::DTO {
	...
	API_DTO_FIELD_DEFAULT(String, xauthorDataPathList, "xauthorDataPathList");
	...
	API_DTO_FIELD_DEFAULT(String, xcategoryId, "xcategoryId");
	API_DTO_FIELD_DEFAULT(String, xcategoryIdDataPath, "xcategoryIdDataPath");
	API_DTO_FIELD_DEFAULT(String, xcategorySelectType, "xcategorySelectType");
	API_DTO_FIELD_DEFAULT(String, xcmsCreatorIdentity, "xcmsCreatorIdentity");
	API_DTO_FIELD_DEFAULT(String, xcmsCreatorScript, "xcmsCreatorScript");
	API_DTO_FIELD_DEFAULT(String, xcmsCreatorScriptText, "xcmsCreatorScriptText");
	API_DTO_FIELD_DEFAULT(String, xpublishCmsCreatorType, "xpublishCmsCreatorType");
	...
	API_DTO_FIELD_DEFAULT(String, xnotifyDataPathList, "xnotifyDataPathList");
	API_DTO_FIELD_DEFAULT(String, xopinionGroup, "xopinionGroup");
	API_DTO_FIELD_DEFAULT(String, xpictureDataPathList, "xpictureDataPathList");
	...
	API_DTO_FIELD_DEFAULT(String, xpublishTarget, "xpublishTarget");
	...
	API_DTO_FIELD_DEFAULT(String, xreaderDataPathList, "xreaderDataPathList");
	...
	API_DTO_FIELD_DEFAULT(String, xtargetAssignDataScript, "xtargetAssignDataScript");
	API_DTO_FIELD_DEFAULT(String, xtargetAssignDataScriptText, "xtargetAssignDataScriptText");
	API_DTO_FIELD_DEFAULT(String, xtitleDataPath, "xtitleDataPath");
	API_DTO_FIELD_DEFAULT(Boolean, xuseProcessForm, "xuseProcessForm");
};
