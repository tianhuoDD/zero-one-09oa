...
class DelayDTO : public oatpp::DTO {
	DTO_INIT(DelayDTO, DTO);
	...
	API_DTO_FIELD_DEFAULT(String, xdelayDataPath, "xdelayDataPath");
	API_DTO_FIELD_DEFAULT(UInt64, xdelayMinute, "xdelayMinute");
	API_DTO_FIELD_DEFAULT(String, xdelayScript, "xdelayScript");
	API_DTO_FIELD_DEFAULT(String, xdelayScriptText, "xdelayScriptText");
	API_DTO_FIELD_DEFAULT(String, xdelayTime, "xdelayTime");
	API_DTO_FIELD_DEFAULT(String, xdelayType, "xdelayType");
	...
	API_DTO_FIELD_DEFAULT(Boolean, xworkMinute, "xworkMinute");
};
