...
class AgentDO {
	...
	CC_SYNTHESIZE(string, xagentInterruptScript, XagentInterruptScript);
	CC_SYNTHESIZE(string, xagentInterruptScriptText, XagentInterruptScriptText);
...
public:
	AgentDO() {
		...
		this->xagentInterruptScript = "";
		this->xagentInterruptScriptText = "";
		this->xalias = "";
