...
class DelayDO {
	...
	CC_SYNTHESIZE(string, xdelayDataPath, XdelayDataPath);
	CC_SYNTHESIZE(int, xdelayMinute, XdelayMinute);
	CC_SYNTHESIZE(string, xdelayScript, XdelayScript);
	CC_SYNTHESIZE(string, xdelayScriptText, XdelayScriptText);
	CC_SYNTHESIZE(string, xdelayTime, XdelayTime);
	CC_SYNTHESIZE(string, xdelayType, XdelayType);
	...
	CC_SYNTHESIZE(bool, xworkMinute, XworkMinute);
public:
	DelayDO() {
		this->xid = "";
		this->xcreateTime = "";
