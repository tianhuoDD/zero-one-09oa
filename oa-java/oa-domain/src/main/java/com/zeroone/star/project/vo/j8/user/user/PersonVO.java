package com.zeroone.star.project.vo.j8.user.user;
...
public class PersonVO {
    ...
    @ApiModelProperty(value = "失败次数", example = "2")
    private Integer xfailureCount;

    @ApiModelProperty(value = "失败时间", example = "2023-02-01 12:00:00")
    private String xfailureTime;
    ...
    @ApiModelProperty(value = "最后登录地址", example = "192.168.1.100")
    private String xlastLoginAddress;

    @ApiModelProperty(value = "最后登录客户端", example = "Chrome")
    private String xlastLoginClient;

    @ApiModelProperty(value = "最后登录时间", example = "2023-02-01 12:00:00")
    private String xlastLoginTime;

    @ApiModelProperty(value = "锁定时间", example = "2023-03-01 12:00:00")
    private String xlockTime;
    ...
    @ApiModelProperty(value = "密码过期时间", example = "2023-12-31")
    private String xpasswordExpiredTime;
