...
public class EndDTO {
    ...
    @ApiModelProperty(value = "主键ID",example = "cc88613a-637d-41fb-ace6-8f4ba4a0073b")
    private String xid;
    ...
    @ApiModelProperty(value = "是否允许调度",example = "ture")
    private Boolean xallowReroute;

    @ApiModelProperty(value = "是否允许调度到此活动",example = "ture")
