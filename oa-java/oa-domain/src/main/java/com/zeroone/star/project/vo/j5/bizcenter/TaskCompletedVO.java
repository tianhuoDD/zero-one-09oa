...
public class TaskCompletedVO {
    ...
    @ApiModelProperty(value = "授权目标身份")
    @Alias("xempowerToIdentity")
    ...
    @ApiModelProperty(value = "催办活动令牌")
    @Alias("xpressActivityToken")
