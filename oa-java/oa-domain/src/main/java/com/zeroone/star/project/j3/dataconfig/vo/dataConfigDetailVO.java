...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(description = "数据配置详细信息显示对象")
public class dataConfigDetailVO implements Serializable {
    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "数据配置信息", example = "{'ignoreTitle':true,'latest':false,'saveDraftOnClose':true}")
