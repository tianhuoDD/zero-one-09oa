...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(description = "用户密码配置显示对象")
public class UserPasswordConfigVO {
    /**
     * 初始密码生成方式
     * 1. 手机号码后六位
     * 2. 唯一编码后六位
     ...
     * 密码过期天数(0表示永不过期)
     */
    @ApiModelProperty(value = "密码过期天数(0表示永不过期)", example = "0")
    private Integer passwordExpireTime;

    /**
     * 最小密码长度
     */
    @ApiModelProperty(value = "最小密码长度", example = "8")
    private Integer passwordLengthMin;

    /**
     * 最大密码长度
     */
    @ApiModelProperty(value = "最大密码长度", example = "30")
