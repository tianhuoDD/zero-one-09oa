...
public class InvokeDTO {
    ...
    @ApiModelProperty(value = "调用方式",example = "false")
    ...
    @ApiModelProperty(value = "系统内请求",example = "false")
    private Boolean xinternal;

    @ApiModelProperty(value = "服务协议",example = "jaxrs")
    private String xinvokeMode;

    @ApiModelProperty(value = "jaxrs模式下的REST地址",example = "")
    private String xjaxrsAddress;

    @ApiModelProperty(value = "ContentType",example = "")
    private String xjaxrsContentType;

    @ApiModelProperty(value = "jaxrs模式下的请求方式",example = "GET")
    private String xjaxrsMethod;

    @ApiModelProperty(value = "jaxrs模式下的密码",example = "")
    private Boolean xjaxrsWithCipher;

    @ApiModelProperty(value = "jaxws模式下的REST地址",example = "")
    private String xjaxwsAddress;

    @ApiModelProperty(value = "jaxws模式下请求方式",example = "GET")
