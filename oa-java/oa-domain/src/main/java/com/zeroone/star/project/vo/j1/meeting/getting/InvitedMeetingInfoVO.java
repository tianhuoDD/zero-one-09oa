package com.zeroone.star.project.vo.j1.meeting.getting;
 ...
 * @Description: 邀请我的会议信息对应的领域模型VO
 * @Version: 1.0
 */
@Data
@ApiModel("邀请我的会议信息传输数据对象")
public class InvitedMeetingInfoVO {
    /**
     * @description: 会议id
     **/
     ...
     **/
    @ApiModelProperty(value = "会议实际结束时间", example = "2024-10-21-00:00:00")
     ...
     **/
    @ApiModelProperty(value = "会议实际开始时间", example = "2024-10-21-00:00:00")
    @TableField(fill = FieldFill.INSERT_UPDATE)
     ...
     * @description: 会议确认状态
     **/
    @ApiModelProperty(value = "会议确认状态", example = "1")
    private int xconfirmStatus;
     ...
     * @description: 会议主题
     **/
    @ApiModelProperty(value = "会议主题", example = "oa-开发")
     ...
     * @description: 会议房间地址
     **/
    @ApiModelProperty(value = "会议房间地址", example = "01星球5层会议室1")
