				...
				<el-table ref="multipleTableRef" :data="tableData" style="width: 100%; color: black" border:false>
					...
					<el-table-column prop="xname" label="文件名" width="800">
						<template #default="scope">
							<!-- <img
								v-if="isImage(scope.row.xname)"
								:src="getFileUrl(scope.row.xid)"
								style="width: 24px; height: 24px; margin-right: 10px"
							/> -->
							<!-- <el-icon v-else :size="24" style="margin-right: 10px">
								<component :is="getFileIcon(scope.row.xname)" />
							</el-icon> -->
...
import { MostlyCloudy,  Search } from "@element-plus/icons-vue";
